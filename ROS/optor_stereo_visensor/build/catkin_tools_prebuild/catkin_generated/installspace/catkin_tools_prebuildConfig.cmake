...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/carry/optor_vi-stereo-v1/optor_VI_Sensor_SDK_V1.0/ROS/optor_stereo_visensor/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/carry/optor_vi-stereo-v1/optor_VI_Sensor_SDK_V1.0/ROS/optor_stereo_visensor/install/lib;/opt/ros/kinetic/lib)
